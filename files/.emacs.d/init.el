...
(use-package org
  ...
  (setq org-capture-templates
	'(("t" "todo" entry (file "~/projects/org/refile.org")
	   "* TODO %?\n%U\n%a\n" :clock-in t :clock-resume t)
	  ("r" "respond" entry (file "~/projects/org/refile.org")
	   "* NEXT Respond to %:from on %:subject\nSCHEDULED: %t\n%U\n%a\n" :clock-in t :clock-resume t :immediate-finish t)
	  ("n" "note" entry (file "~/projects/org/refile.org")
	   "* %? :NOTE:\n%U\n%a\n" :clock-in t :clock-resume t)
	  ("j" "JOURNAL" entry (file "~/projects/org/refile.org")
	   "* %?\n%U\n" :clock-in t :clock-resume t)
	  ("w" "org-protocol" entry (file "~/projects/org/refile.org")
	   "* TODO Review %c\n%U\n" :immediate-finish t)
	  ("m" "MEETING" entry (file "~/projects/org/refile.org")
	   "* MEETING with %? :MEETING:\n%U" :clock-in t :clock-resume t)
	  ("p" "Phone call" entry (file "~/projects/org/refile.org")
	   "* PHONE %? :PHONE:\n%U" :clock-in t :clock-resume t)
